...
template <class Comparable>
const Comparable & AvlSearchTree<Comparable>::elementAt( AvlNode<Comparable> *t ) const
{
    return t == nullptr ? ITEM_NOT_FOUND : t->element;
}

template <class Comparable>
const Comparable & AvlSearchTree<Comparable>::find(const Comparable & x) const
{
    return elementAt(find(x, root));
}

template <class Comparable>
AvlNode<Comparable> * AvlSearchTree<Comparable>::find(const Comparable & x, AvlNode<Comparable> * t ) const
{
    if (t == nullptr)
        return nullptr;
    else if(x < t->element)
